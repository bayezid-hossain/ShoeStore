...
const heroapi = {
  ...
  videos: [
    { imgsrc: '/assets/video/vcover1.png', clip: '/assets/video/clip.mp4' },
    { imgsrc: '/assets/video/vcover2.png', clip: '/assets/video/clip.mp4' },
    { imgsrc: '/assets/video/vcover3.png', clip: '/assets/video/clip.mp4' },
  ],
  sociallinks: [
